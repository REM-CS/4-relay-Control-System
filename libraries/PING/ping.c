...
// Compatibility shim:
// Some upstream WIZnet ping examples still reference legacy IINCHIP_* macros.
// The current ioLibrary_Driver exposes WIZCHIP_* instead.
#ifndef IINCHIP_WRITE
#define IINCHIP_WRITE(addr, data) WIZCHIP_WRITE((addr), (data))
#endif
